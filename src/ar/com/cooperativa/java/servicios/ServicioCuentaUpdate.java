...
public class ServicioCuentaUpdate implements Runnable{
    private int port=8204;
    ...
    public void run() {
        try (ServerSocket ss=new ServerSocket(port)) {
            System.out.println("Servicio Cuenta Update: OK");
            while(true){
                ...
                try (
                    ...
                    System.out.println("Servicio Cuenta Update, se conecto "+so.getInetAddress());
                    try {
